...
titleFirstCard.textContent = "I LOVE 🐕‍🦺";
subtitleFirstCard.textContent = "Once upon a time...";
textFirstCard.textContent = "Dogs are human's best friends!!!"
...
logoTitle.className = "logo heading paw";
...
// setInterval(() => header.classList.toggle("sky"),2000);
...
/**
 * dot notation     => blah.name => const blah = {name: "Karen"}
